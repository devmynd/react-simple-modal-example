...
This project is a simple example of a modal written in React. Eventually there'll be a link to a blog post that explains this more in-depth.

You can run it by cloning this repo, installing its dependencies (`yarn install`), and running `yarn start`. If your browser doesn't automatically open to the example, you can visit `localhost:3000` in your browser to see it.
